...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://t.me/yang_woow_bot" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> Telegram bot' +
    '</a> ' + '</div>' + '');
var $window = $(window);
